  ...
  return (
    <div className='carousel'>
      <div className='carousel-slide'>
        <img className='carousel__img' key={currentSlide} src={slides[currentSlide]} alt={`Slide ${currentSlide + 1}`} />
      </div>

      <p key={currentSlide} className='carousel__title'>{titles[currentSlide]}</p>
